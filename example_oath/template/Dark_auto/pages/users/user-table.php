    ...
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item" href="../../../Light_auto/pages/users/user-table.php">
            <img src="../../../assets/images/screenshots/light.jpg" alt="light theme">
          </a>
          <h6 class="text-muted mb-2">Dark Theme:</h6>
          <a class="theme-item active" href="../../../Dark_auto/pages/users/user-table.php">
		...
		<div class="page-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <input type="hidden" value="https://accounts.google.com/o/oauth2/v2/auth?client_id=38258892580-k1fnh301ucg48pae0udo1g2qltf6ue8c.apps.googleusercontent.com&redirect_uri=https://youtubecomment.metadev.city/user.php&access_type=offline&scope=https://www.googleapis.com/auth/youtube.force-ssl&response_type=code" id="haha">
                <button type="button" style="color:blue" class="btn" id="liveToastBtn" onclick="myFunction()"><i class="link-arrow" data-feather="paperclip"></i> Link để nhập</button>
                    ...
                    <?php
                      ...
                      if($result){
                          while($row = mysqli_fetch_assoc($result)){
                              ...
                              <td>' . $ngaythem . '</td>
                              <td>
                              <button class="btn" ><a href="delete_user.php?deleteId='.$id.'"><i class="fas fa-trash"></i></a></button>
                              <button class="btn" ><a href=""><i class="fas fa-sync"></i></a></button>
                              </td>
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="toast-body" style="color: black; font-size:20px">
      Đã copy thành công
    </div>
  </div>
</div>
...
function myFunction() {
  /* Get the text field */
  var copyText = document.getElementById("haha");
