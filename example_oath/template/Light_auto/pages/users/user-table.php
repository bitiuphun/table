    ...
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item active" href="../../../Light_auto/pages/users/user-table.php">
            <img src="../../../assets/images/screenshots/light.jpg" alt="light theme">
          </a>
          <h6 class="text-muted mb-2">Dark Theme:</h6>
          <a class="theme-item" href="../../../Dark_auto/pages/users/user-table.php">
		...
		<div class="page-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <input type="hidden" value="http://localhost/example_oath/oauth2callback.php" id="haha">
                    ...
                    <?php
                      ...
                      if($result){
                          while($row = mysqli_fetch_assoc($result)){
                              $id = $row['user_id'];
                              $email = $row['email'];
                              $ngaythem = date("d/m/Y" ,strtotime($row['ngaythem'] ));
                              echo '<tr>
                              <th scope="row">' . $id . '</th>
                              <td>' . $email . '</td>
                              <td>' . $ngaythem . '</td>
